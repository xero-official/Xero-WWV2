...
TXFEE_Desc                  : 'Les frais de transaction sont payés aux mineurs pour inclure votre transaction dans un bloc. Cela représente le `GAS limite` * le `prix du GAS`. [Vous pouvez convertir GWEI -> XERO ici.](https://vintage.myetherwallet.com/helpers.html)',
...
/* Footer */
FOOTER_1                    : 'Un outil open source, écrit en Javascript, qui permet de générer des portefeuilles Xerom et d\'envoyer des transactions. ',
FOOTER_1b                   : 'Créé par ',
...
TRANS_data                  : 'Données',
TRANS_sendInfo              : 'Une transaction standard utilisant 21000 GAS coûtera 0,000441 XERO. Le prix du GAS, de 0.000000021 XERO, que nous avons choisi est légèrement supérieur au minimum assurant une confirmation rapide. Nous ne prenons pas de frais de transaction.',
...
TRANSModal_Content_2        : '**XERO seulement :** Envoi à travers le [contrat anti-réexécution de Timon Rapp (recommandé par VB)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) afin de n\'envoyer que sur la chaîne **XERO**.',
...
ADD_Ledger_2                : 'Ouvrez l\'application Xerom (ou une application de contrat)',
...
SWAP_order_CTA              : "Envoyer ", // Please send 1 XERO...
...
GXERO_Balance                : '(geth-01) Insufficient balance. Your gas limit * gas price + amount to send exceeds your current balance. Send more XERO to your account or use the "Send Entire Balance" button. If you believe this is in error, try pressing generate again. Required (d+) and got: (d+). [Learn More.](https://kb.myetherwallet.com/transactions/transactions-not-showing-or-pending.html). Solde insuffisant',
GXERO_Cheap                  : '(geth-02) Gas price too low for acceptance. Try raising the gas price to 21 GWEI via the dropdown in top-right. Prix du Gas trop bas pour être accepté',
GXERO_GasLimit               : '(geth-03) Exceeds block gas limit. Transaction cost exceeds current gas limit. Limit: (d+), got: (d+). Please lower the gas limit to 21000 (for sending) or 200000 (for sending tokens or contracts) and try again. [Learn More](https://kb.myetherwallet.com/gas/what-is-gas-ethereum.html). Limite de Gas dépassée',
GXERO_InsufficientFunds      : '(geth-04) Insufficient balance. Your gas limit * gas price + amount to send exceeds your current balance. Send more XERO to your account or use the "Send Entire Balance" button. If you believe this is in error, try pressing generate again. Required (d+) and got: (d+). [Learn More.](https://kb.myetherwallet.com/transactions/transactions-not-showing-or-pending.html). Fonds insuffisants pour (Gas * prix) + valeur',
GXERO_IntrinsicGas           : '(geth-05) Intrinsic gas too low. Try raising the gas price to 21 GWEI via the dropdown in top-right or the gas limit to 21000 (for sending) or 200000 (for sending tokens or contracts) and try again. Gas intrinsèque trop bas',
GXERO_InvalidSender          : '(geth-06) Invalid sender. Expéditeur invalide',
GXERO_NegativeValue          : '(geth-07) Negative value. Valeur négative',
GXERO_Nonce                  : '(geth-08) This TX\'s [nonce](https://kb.myetherwallet.com/transactions/what-is-nonce.html) is too low. Try incrementing the nonce by pressing the Generate button again, or [replace the pending transaction](https://kb.myetherwallet.com/transactions/check-status-of-ethereum-transaction.html). Nonce trop bas',
GXERO_NonExistentAccount     : '(geth-09) Account does not exist or account balance too low. Compte inexistant ou solde du compte trop bas',
...
HELP_8_Desc_2               : 'Si MyEtherWallet.com venait à être hors ligne, vous devrez trouver un autre moyen (comme Geth ou Xerom Wallet / Mist) pour faire la même chose. Mais vous n\'aurez pas à "récupérer" votre Ether depuis MyEtherWallet parce qu\'il ne se trouve pas dans MyEtherWallet. Il est chez vous, dans le portefeuille que vous avez généré par notre site.',
HELP_8_Desc_3               : 'Vous pouvez maintenant importer facilement votre clef privée non chiffrée et vos fichiers (chiffrés) au format Geth/Mist, directement dans geth / Xerom Wallet / Mist. Voir question #12 ci-dessous.',
...
HELP_12_Title               : '12) Comment puis-je importer un portefeuille créé par MyEtherWallet dans geth, Xerom Wallet ou Mist ?',
...
HELP_12_Desc_7              : 'Ouvrez l\'application Xerom Wallet. ',
...
HELP_12_Desc_20             : 'Ceci vous invitera à choisir un nouveau mot de passe. C\'est celui que vous utiliserez dans geth / Xerom Wallet / Mist à chaque vois que vos créerez une transaction, alors ne l\'oubliez pas. ',
HELP_12_Desc_21             : 'Après que l\'import ait réussi, supprimez `nothing_special_delete_me.txt` ',
HELP_12_Desc_22             : 'La prochaine fois que vous ouvrirez l\'application Xerom Wallet, votre compte sera listé sous "Accounts". ',
...
HELP_12_Desc_26             : 'Ceci vous invitera à choisir un nouveau mot de passe. C\'est celui que vous utiliserz dans geth / Xerom Wallet / Mist à chaque foiq que vous créerez une transaction, alors ne l\'oubliez pas. ',
HELP_12_Desc_27             : 'Après que l\'import ait réussi, supprimez `nothing_special_delete_me.txt` ',
HELP_12_Desc_28             : 'La prochaine fois que vous ouvrirez l\'application Xerom Wallet, votre compte sera listé sous "Accounts". ',
...
HELP_21_Desc_2              : 'Version longue : Xerom est basé sur la [Cryptographie asymétrique](https://fr.wikipedia.org/wiki/Cryptographie_asymétrique), plus précisément la [cryptographie des courbes elliptiques (ECC)](https://eprint.iacr.org/2013/734.pdf) qui est très couramment employée, non pas uniquement dans Xerom. La plupart des serveurs sont protégés par les ECC. Bitcoin les emploie, ainsi que SSH, TLS et bien d\'autres protocoles. Dans le cas spécifique d\'Xerom, les clefs font 256 bits et sont plus fortes que celles en 128 et 192 bits, encore très employées et toujours considérées comme sûres par les experts.',
