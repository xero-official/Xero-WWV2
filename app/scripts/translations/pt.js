...
/* Footer */
FOOTER_1                    : 'Uma fonte aberta, javascript, ferramenta do client-side para gerar Carteiras Xerom & envio de transações. ',
...
/* Send Transaction */
TRANS_desc                  : '',
TRANS_warning               : 'Se você estiver usando somente "XERO" ou "ETC" Funções que você está enviando através de um contrato. Alguns serviços têm problemas para aceitar essas transações. Leia mais. ',
TRANS_advanced              : '+Avançado: Adicionar dados ',
TRANS_data                  : 'Dados ',
TRANS_gas                   : 'Gás Limit ',
TRANS_sendInfo              : 'Uma transação padrão usando 21000 gás irá custar 0.000441 XERO. Nós usamos um preço ligeiramente acima do mínima de gás de 0,000000021 XERO para garantir que ele seja minado rapidamente. Nós não recebemos nenhuma taxa de transação. ',

/* Send Transaction Modals */
TRANSModal_Title            : '"Só XERO" e "Só ETC" Transações ',
...
TRANSModal_Content_2        : '**Só XERO: ** Isso envia via [Timon Rapp\'s contrato de proteção de repetição (como recomendado pelo VB)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) para que você só envie na cadeia **XERO**. ',
...
ADD_Ledger_2                : 'Abra a aplicação Xerom (ou uma aplicação de contrato) ',
