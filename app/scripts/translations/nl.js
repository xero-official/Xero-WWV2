...
TXFEE_Desc                  : 'De TX vergoeding (`fee`) wordt betaald aan de miners om jouw TX in een blok op de blockchain op te nemen. De vergoeding is de `gas limiet` * `gas prijs`. [Je kunt hier GWEI -> XERO converteren](https://vintage.myetherwallet.com/helpers.html)',
...
/* Footer */
FOOTER_1                    : 'Een gratis, open source, client-side interface om Xerom wallets te genereren &amp; meer. Wissel op een gemakkelijke &amp; veilige manier informatie uit met de Xerom blockchain. Dubbel-check de URL/link ( myetherwallet.com ) alvorens je wallet te openen.',
...
ADD_Ledger_2                : 'Open de Xerom applicatie (of een contract applicatie) ',
...
SWAP_order_CTA              : "Verzend alsjeblieft ", // Please send 1 XERO...
...
/* Geth Error Messages */
GXERO_InvalidSender          : 'Ongeldige verzender ',
GXERO_Nonce                  : 'Nonce te laag ',
GXERO_Cheap                  : 'Gas prijs te laag voor acceptatie ',
GXERO_Balance                : 'Ontoereikend saldo ',
GXERO_NonExistentAccount     : 'Account bestaat niet of account saldo te laag ',
GXERO_InsufficientFunds      : 'Ontoereikend saldo voor gas * prijs + waarde ',
GXERO_IntrinsicGas           : 'Intrinsiek gas te laag ',
GXERO_GasLimit               : 'Overstijgt blok gas limiet ',
GXERO_NegativeValue          : 'Negative waarde ',
...
HELP_8_Desc_2               : 'Als MyEtherWallet.com er mee stopt, zul je een andere manier moeten zien te vinden (zoals geth of Xerom Wallet / Mist) om te doen wat wij doen. Maar wat je niet zult hoeven te doen is je Ether uit MyEtherWallet halen omdat het niet in MyEtherWallet zit. Je Ether zit in in welk wallet dan ook je op onze site hebt gegenereerd. ',
HELP_8_Desc_3               : 'Je kunt je  onversleutelde (unencrypted) prive sleutel en je Geth/Mist Formaat (encrypted) bestanden heel gemakkelijk en direct in geth / Xerom Wallet / Mist importeren. Zie onderstaande vraag #12. ',
...
HELP_12_Title               : '12) Hoe importeer ik een MyEtherWallet  wallet in geth / Xerom Wallet / Mist? ',
...
HELP_12_Desc_7              : 'Open de Xerom Wallet applicatie. ',
...
HELP_12_Desc_20             : 'Je zal gevraagd worden om een nieuw wachtwoord. Dit is het wachtwoord wat je zult gebruiken in geth / Xerom Wallet / Mist elke keer als je een transactie verzend, dus zorg dat je dit niet vergeet. ',
HELP_12_Desc_21             : 'Verwijder het bestand `niets_bijzonders_verwijder_mij.txt` na een geslaagde import. ',
HELP_12_Desc_22             : 'De volgende keer dat je de Xerom Wallet applicatie opent, zal je account worden vermeld onder "Accounts". ',
...
HELP_12_Desc_26             : 'Je zal gevraagd worden om een nieuw wachtwoord. Dit is het wachtwoord wat je zult gebruiken in geth / Xerom Wallet / Mist elke keer als je een transactie verzend, dus zorg dat je dit niet vergeet. ',
HELP_12_Desc_27             : 'Verwijder het bestand `niets_bijzonders_verwijder_mij.txt` na een geslaagde import. ',
HELP_12_Desc_28             : 'De volgende keer dat je de Xerom Wallet applicatie opent, zal je account worden vermeld onder "Accounts". ',
...
HELP_21_Desc_2              : 'De lange ELI5 versie: Xerom is gebasserd op [Publieke Sleutel Cryptografie](https://en.wikipedia.org/wiki/Public-key_cryptography), en meer specifiek op [Elliptische curve cryptografie](https://eprint.iacr.org/2013/734.pdf) wat op grote schaal gebruikt wordt, niet alleen in Xerom. De meeste van onze servers zijn beveiligd via ECC. Bitcoin maakt hier ook gebruik van, net als SSH, TLS en vele andere dingen. De specifieke Xerom sleutels zijn 256-bit sleutels, welke sterker zijn dan 128-bit en 192-bit, terwijl die ook op grote schaal gebruikt worden en no steeds als veilig worden beschouwd door experts. ',
