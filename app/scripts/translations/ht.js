...
tx_FoundOnChain_3           : '**Si vous ne voyez pas d\'erreur, votre transaction a été envoyée avec succès.** Vos XERO ou Tokens sont à l\'endroit où vous les avez envoyés. Si vous ne voyez pas ces XERO ou Tokens dans votre autre portefeuille ou compte de place d\'échange, et si cela fait plus de 24 heures, veuillez [contacter ce service](https://kb.myetherwallet.com/diving-deeper/ethereum-list-of-support-and-communities.html). Envoyez-leur le *lien* vers votre transaction et demandez, poliment, d\'examiner votre situation.',
...
TXFEE_Desc                  : 'Les frais de transaction sont payés aux mineurs pour inclure votre transaction dans un bloc. Cela représente le `gas limit` * le `gas price`. [Vous pouvez convertir GWEI -> XERO ici](https://vintage.myetherwallet.com/helpers.html)',
...
/* General */
x_Access                    : 'ANTRE ',
x_AddessDesc                : 'LI RELE ANKÒ‘’NIMEWO KONT’’ OSWA ‘’ KLE PIBLIK’’ SE SA W’ KA VOYE BAY TOUT MOUN POU YO KA VOYE XEROER YO BA W’. PYON SA SE YON FASON SENP POU KONNEN ADRÈS OU ',
x_Address                   : 'ADRÈS OU ',
x_Cancel                    : 'RETIRE ',
x_CSV                       : 'PAJ  CSV SAN KÒD ',
x_Download                  : 'PRAN L ',
x_Json                      : 'PAJ JSON (SAN-KÒD) ',
x_JsonDesc                  : 'SE YON LÒT VÈSYON SAN KÒD SOU FÒM JSON POU KLE SEKRÈ W’LA. SA VLE DI KE W’ PA BEZWEN KÒD SEKRÈ W’ POU W’ SÈVI AK LI MEN NENPÒT MOUN KI JWENN JSON AN KAPAB ANTRE NAN BOUS OU A AK XEROER W’ YO SAN KÒD SEKRÈ ',
...
/* Footer */
FOOTER_1                    : 'YON ZOUTI OPEN SOURCE NAN JAVASCRIPT LI FÈT POU KLIYAN KREYE BOUS  XEROEREUM YO EPI FÈ ANPIL TRANSFÈ ',
...
sidebar_donation            : 'MYXEROERWALLET  SE YON SÈVIS GRATIS EPI YON OPEN SOURCE KI RESPEKTE VI SEKRÈ W’ AK SEKIRITE W’. PLIS N’AP JWENN ANPIL DON, PLIS N’AP PASE ANPIL TAN POU N’ DEVLOPE LÒT FONKSYON YO, N’AP TANDE SA W’ MANDE  AK BA W’ SA W’ BEZWEN . NOU SE KÈK MOUN K’AP ESEYE CHANJE MOND LA. EDE NOU! ',
...
ADD_Ledger_2                : 'Open the Xerom application (or a contract application) ',
...
ADD_Warning_1               : 'OU KAPAB METE NENPÒT KI KONT POU W’ FÈ L’ PARÈT NAN TI BWAT « BOUS YO » SAN W’ PA PRAN YON KLE SEKRÈ. SA **PA** VLE DI KE W’AP KA ANTRE NAN BOUS SA, NI POU W’ TA FÈ TRANSFÈ XEROER YO SÒTI NAN BOUS SA ',
...
/* full sentence reads "You are about to send "10 XERO" to address "0x1234". Are you sure you want to do this? " */                                                                                                  /*PLEN FRAZ POU LI ‘’ OU PRAL VOYE L’ ‘’10XERO’’ NAN ADRÈS ‘’0X1234’’ ESKE W’ KONFYAN OU VLE FÈ SA ?’’*/
SENDModal_Content_1         : 'OU PRAL VOYE L ',
SENDModal_Content_2         : 'NAN ADRÈS ',
SENDModal_Content_3         : 'ESKE W KONFYAN ?  ',
SENDModal_Content_4         : 'NÒT :SI JWENN AK YON ERÈ, OU TA GEN POU METE XEROER YO NAN KONT OU A POU W’ KOUVRI KÒB GAZ POU VOYE TOKENS YO. GAZ LA PEYE AK XEROER ',
...
TRANS_warning               : 'METE FONKSYON ‘’XERO’’ YO SÈLMAN  AK ‘’ETC SÈLMAN’’ OU FÈ W’ PASE NAN YON KONTRA. KÈK NAN SÈVIS SA YO KONN GEN PWOBLÈM  AK TRANSFÈ SA YO. POU W’  KONN PLIS ',
TRANS_advanced              : '+AVANSE : METE GAZ ',
TRANS_data                  : 'DONE ',
TRANS_gas                   : 'LIMIT AN GAZ ;// CHANJE AN ENG POU LIMIT GAZ LA ',
TRANS_sendInfo              : 'YON TRANSFÈ NÒMAL SÈVI  AK 21000 GAZ KI KOUTE 0.000441  XERO. PRI GAZ LA 0.000000021 XERO  KE NOU TE CHWAZI A ON TI JAN PI WO KE  PI PITI A ASIRE W’ POU W’ YON KONFIMASYON RAPID. NOU PA PRAN FRÈ POU TRANSFÈ A.  ',
...
NODE_Warning                : 'NE W’ LA DWE AN HTTPS POU W’ KONEKTE AVÈK MYXEROERWALLET.COM. OU KAPAB [PRAN REPO MYWALLET LA EPI OUVRI  L’ LOKALMAN ](https://github.com/kvhnuke/etherwallet/releases/latest) POU W’ KONEKTE A KÈK LÒT NE , OSWA POU W’ GENYEN SÈTIFIKA SSL GRATIS AVÈK[LetsEncrypt](https://letsencrypt.org/).',
NODE_Name                   : 'NON NE A ',
NODE_Port                   : 'PÒ NE A ',
...
/* View Wallet Details */
VIEWWALLET_Subtitle         : 'SA PÈMÈT OU POU W’ PRAN PLIZYÈ VÈZSYON KLE SEKRÈ  YO EPI AK SÒTI BOUS OU A ANKÒ SOU PAPYE. OU DWE FÈ L’ POU [ PRAN KONT OU A NAN GXERO/MIST] (http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). SI W’ VLE  WÈ VALÈ KÒB OU A, NOU MANDE W’ POU SÈVI AK YON EKSPLORATÈ POU BLOCKCHAIN TANKOU[etherscan.io](https://etherscan.io/).',
...
ERROR_17                    : 'IFONDS LA YO PA SIFI. KONT KOTE W’AP ESEYE VOYE TRANSFÈ A PA GEN ASE PWOVISYON. FÒK OU TA GENYEN POU PI PITI 0,01 XEROER SOU KONT OU A POU W’ KA KOUVRI KÒB GAZ YO. METE XEROER YO EPI ESEYE ANKÒ ',
...
/* Geth Error Messages */
GXERO_InvalidSender          : 'MOUN K’AP VOYE L’ PA BON ',
GXERO_Nonce                  : 'NONCE TWÒ BA ',
GXERO_Cheap                  : 'PRI GAZ LA TWO BA POU L’ AKSEPTE ',
GXERO_Balance                : 'KANTITE A PA SIFI ',
GXERO_NonExistentAccount     : 'KONT SA PA EGZISTE OSWA KANTITE KI NAN KONT LA TWÒ BA ',
GXERO_InsufficientFunds      : 'KÒB SA YO PA SIFI POU GAZ *PRI+VALÈ ',
GXERO_IntrinsicGas           : 'VALÈ GAZ LA TWO BA ',
GXERO_GasLimit               : 'LIMIT GAZ LA DEPASE ',
GXERO_NegativeValue          : 'VALÈ A PA BON ',
...
HELP_Remind_Desc_1          : 'XEROEREUM, MYXEROERWALLET.COM & MYXEROER WALLET CX, EPI KÈK NAN BIBLIYOTÈK YO  JAVASCRIPT KI ANBA KE NOU KONN SÈVI AK YO KÒMANSE AP DEVLOPE.** NOU PASE YO GWO TÈS EPI ANPIL DIZÈNN AK MILYE BOUS SA YO TE KREYE AVÈK ANPIL SIKSÈ TOUT KOTE NAN MOND LA. KA TOUJOU GEN YON TI KRAS POSIBLITE KE YON BAGAY KA PASE KI KA PÈMÈT OU PÈDI XERO OU YO. PA ENVESTI PLIS PLIS KE SA W ‘ KA PRÈ POU W’ PÈDI EPI PRIDANS. NAN KA AKSIDAN, N’AP DEZOLE MEN ** NOU P’AP RESPONSAB POU XEROER  SA W’ PÈDI A** ',
HELP_Remind_Desc_2          : 'MYXEROERWALLET.COM & MYXEROERWALLET CX YO PA "BOUS WEB". OU PA KREYE YON KONT , OU PA BA NOU XEROER W’ YO TANKOU DEPO. OKENN DONE PA SÒTI NAN KOMPITÈ W’ OSWA NAVIGATÈ W’ LA. N’AP FASILITE W’ POU W KREYASYON AN. KIJAN POU KENBE  L’ EPI ANTRE NAN ENFÒMASYON W’ YO AK KONTAK OU MENM AK BLOCKCHAIN NAN. ',
...
HELP_0_Desc_1               : 'MYXEROERWALLET BA W’ MWAYEN POU W’ KREYE PLIZYÈ LÒT BOUS POU W’ KACHE XEROER OU A OU MENM EPI SE PA SOU YON ** CHANJ** PWOSESIS SA KA FÈT SOU YON KOMPITÈ, SE PA SOU SÈVÈ NOU YO. LÈ W’AP KREYE YON LÒT BOUS ** SE RESPONSABLITE W’ POU W’ BYEN KENBE L’ AN SEKIRITE** ',
...
HELP_0_Desc_5               : 'VOYE XEROER A NAN LÒT BOUS SA. ',
...
HELP_2a_Desc_2              : 'ANREJISTRE ADRÈS LA, OU KAPAB GENYEN L’ POU OU SÈL OSWA PATAJE L’ AVÈK LÒT MOUN, NAN FASON TOUT MOUN KAPAB VOYE XEROER BA W’. ',
HELP_2a_Desc_3              : 'ANREJISTRE KLE SEKRÈ W’ NAN PLIZYÈ FASON. PA PATAJE L’ AK OKENN MOUN. KLE SEKRÈ LA NESESÈ POU W’ ANTRE  NAN XEROER W’ LA. POU W’ VOYE L !’ GEN 3 DIFERAN KLE SEKRÈ  KI EGZISTE: ',
...
HELP_2b_Title               : '2b) KÒMAN POU M’ JERE AK TOUT SEKIRITE YON MAGAZEN SAN SIYAL AVÈK MYXEROERWALLET? ',
...
HELP_3_Desc_1               : '** ANVAN W’ VOYE XEROER NAN BOUS OU A** OU DWE GEN ASIRANS KE W’ ANTRE. ',
HELP_3_Desc_2               : 'NAVIGE  AL NAN PAJ "FÈ PARÈT YON BOUS". ',
HELP_3_Desc_3               : 'NAVIGE AL NAN PAJ  " FÈ PARÈT YON BOUS"  MYXEROERWALLET.COM LA. ',
...
HELP_3_Desc_8               : 'SI W’ VLE GEN YON GWO KANTITTE XEROER, NOU MANDE W’ POU W’ KÒMANSE VOYE YON TI KANTITE KÒB KI AP SÒTI NAN BOUS OU FENK GENYEN AN ANAVN W’ METE YON GWO KANTITE KÒB. VOYE 0,001 XEROER AL NAN BOUS OU FENK GENYEN AN, ANTRE LADAN L’ EPI VOYE 0,001 XEROER SA YO AL NAN YON LÒT ADRÈS, EPI VERIFYE  KE TOUT BAGAY AP BYEN FONKSYONE SAN PWOBLÈM. ',

HELP_4_Title                : '4) KÒMAN POU M’ KA VOYE XEROER A SÒTI NAN BOUS SA AL NAN YON LÒT? ',
HELP_4_Desc_1               : 'SI W’ VLE FÈ YON  GWO KANTITE  TRANSFÈ XEROER, OU DWE AVAN TOUT BAGAY ESEYE VOYE YON TI KANTITE KÒB AL NAN BOUS OU A POU GEN KONFYANS KE TOUT BAGAY AP BYEN FONKSYONE JAN SA DWE YE. ',
HELP_4_Desc_2               : 'NAVIGE AL NAN PAJ  "VOYE XEROER YO EPI TOKENS YO" . ',
...
HELP_4CX_Title              : '4) KÒMAN POU M’ KA VOYE RTHER AVÈK MYXEROERWALLET CX ? ',
HELP_4CX_Desc_1             : 'ANVAN, OU DWE METE YON BOUS. SA FÈT, OU GENYEN DE FASON : FONKSYON  "VOYE RAPID"  NAN PYON AN NAN EXTENSION CHROME OSWA PAJ "VOYE XEROER YO EPI  TOKENS YO". ',
...
HELP_4CX_Desc_12            : 'AVÈK PAJ "VOYE XEROER YO EPI AK TOKENS YO" ',

HELP_5_Title                : '5) KÒMAN M KA OUVRI MYXEROERWALLET.COM SAN SIYAL/LOKAL ? ',
HELP_5_Desc_1               : 'OU KAPAB OUVRI MYXEROERWALLET.COM SOU KOMPITÈ W’ LA SAN W’ PA PASE NAN SÈVÈ GITHUB YO. OU KAPAB KREYE YON BOUS SAN OU PA BEZWEN GEN SIYAL EPI VOYE TRANSFÈ YO SÒTI NAN PAJ SA "TRANSFÈ SAN SIYAL". ',
HELP_5_Desc_7               : 'TOUT MYXEROERWALLET.COM LA VIRE SOU KOMPITÈ W’ LA KOUNYE A. ',
HELP_5_Desc_8               : 'NAN KA OU PA TA ABITYE  AK SA. OU DWE KONSÈVE TOUT DOSYE A POU W’ VIRE SIT WEB LA EPI  PA SÈLMAN INDEX.HTML. PA MANYEN ANYEN, PA DEPLASE ANYEN NAN DOSYE A. SI W’ KENBE YON REPO NAN MAGAZEN MYXEROERWALLET POU LÒT JOU YO, NOU MANDE W’ PA METE ZIP LA SÈLMAN NAN MAGAZENN AN POU W’ KA ASIRE W’ KE DOSYE A PA GEN TACH. ',
HELP_5_Desc_9               : 'NOU TOUJOU AP AMELYORE MYXEROERWALLET.COM, NOU MANDE W’ POU W’ TOUJOU METE A JOU VÈSYON W’ TE KENBE A. ',
...
HELP_8_Desc_1               : 'MYXEROERWALLET SE PA YON BOUS SOU WÈB LA. OU PA GEN KONEKSYON EPI ANYEN PA JANM ANREJISTRE SOU SÈVÈ NOU YO. SE JIS YON LÒT FAS KI PÈMET OU PALE AK BLOCKCHAIN LA. ',
HELP_8_Desc_2               : 'SI MYXEROERWALLET.COM TONBE, OU DWE JWENN YON LÒT MWAYEN ( TANKOU GXERO OSWA XEROEREUM WALLET / MIST) POU FÈ MENM BAGAY LA. MEN OU PA GEN POU "REPRAN " XEROER W’ LA KI NAN MY XEROERWALLET PASKE L’ PA NAN MY XEROERWALLET. LI LAKAY OU. NAN BOUS SA W’ TE KREYE SOU SIT NOU AN. ',
HELP_8_Desc_3               : 'OU KAPAB PRAN KLE SEKRÈ W’ LA FASIL KOUNYE A SAN KÒD EPI PAJ OU YO (KÒD) SOU FÒM GXERO/MIST, DIREKTEMAN NAN GXERO/XEROEREUM WALLET / MIST. GADE KESYON #12 LA KI ANBA A. ',
HELP_8_Desc_4               : 'ANPLIS, FASON POU N’ TA KITE MYXEROERWALLET TONBE LI PRE ZEWO.SA KOUTE NOU PRESKE ANYEN POU N’ KENBE L’ TANKOU JAN NOU PA KENBE OKENN ENFÒMASYON. SI DOMÈNN SA TA VIN PÈDI. LOJISYÈL LA AP TOUJOU DISPONIB POU PIBLIK LA SOU [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). OU KAPAB PRAN ZIP LA  EPI SÈVI AK LI LOKAL. ',

HELP_8CX_Title              : '8) SA KI AP PASE SI MYXEROERWALLET CX DISPARÈT ? ',
...
HELP_8CX_Desc_2             : 'SA VLE DI, LI **ENPÒTAN ANPIL**  POU W’ TA KENBE TOUT DONE POU TOUT BOUS OU KREYE YO AK MYXEROERWALLET CX. NAN FASON SA NENPÒT  SA KI TA RIVE MYXEROERWALLET CX OSWA KOMPITÈ W’ LA, W’AP TOUJOU KONSÈVE TOUT ENFÒMASYON NESESÈ YO POU W’ KAANTRE NAN XEROER W’ YO. GADE #2 A POU W’ KENBE BOUS OU YO. ',
HELP_8CX_Desc_3             : 'SI, POU NENPÒT REZON, MYXEROERWALLET CX TA DISPARÈT NAN CHROME STORE A, OU KAPAB JWENN SOUS LA SOU GTITHUB EPI PRAN L’.  GADE #5 KI ANLÈ A. ',
...
HELP_10_Desc_11             : 'SOU KOMPITÈ  AK SIYAL OU A,  KOLE TRANSFÈ KI SIYEN AN NAN ESPAS EKRI A EPI PEZE SOU "VOYE XEROER". SA A AP VOYE TRANSFÈ W’ LA. ',

HELP_12_Title               : '12) KÒMAN POU M’ PRAN YON BOUS KI KREYE AK MYXEROERWALLET NAN GXERO/ XEROEREUM WALLET/ MIST ? ',
HELP_12_Desc_1              : 'AVÈK YON PAJ GXERO/MIST JSON NAN MYXEROERWALLET V2+…. ',
...
HELP_12_Desc_6              : 'ALE NA SEKSYON "PRAN PAJ JSON DOKIMAN- FÒM GXERO/MIST( KI GEN KÒD) ‘’PEZE SOU BOUTON "PRAN L’" KI ANBA . OU GEN KOUNYE A PAJ  *KEYSTORE* W’ LA. ',
HELP_12_Desc_7              : 'OUVRI APLIKASYON  XEROEREUM WALLET. ',
...
HELP_12_Desc_20             : 'SA AP ENVITE CHWAZI YON NOUVO KÒD SEKRÈ. SE SA W’ PRAL ITILIZE NAN GXERO / XEROEREUM WALLET / MIST  NAN CHAK MOMAN OU PRAL FÈ YON TRANSFÈ. KIDONK PA BLIYE L’. ',
HELP_12_Desc_21             : 'APRÈ SA W’ FIN PRAN AN FINI, EFASE NOTHING_SPECIAL_DELETE_ME.TXT` ',
HELP_12_Desc_22             : 'LÈ W’AP OUVRI APLIKASYON XEROEREUM WALLET LA YON LÒT FWA ANKÒ, KONT OU A AP NAN YON LIS NAN "ACCOUNT". ',
...
HELP_12_Desc_26             : 'SA PRAL ENVITE W’ POU CHWAZI YON NOUVO KÒD SEKRÈ. SE AK SA W’ PRAL SÈVI NA GXERO / XEROEREUM WALLET / MIST CHAK FWA OU PRAL VOYE YON TRANFÈ KIDONK PA BLIYE L’. ',
HELP_12_Desc_27             : 'APRÈ SA W’ FIN PRAN AN FINI, EFASE NOTHING_SPECIAL_DELETE_ME.TXT` ',
HELP_12_Desc_28             : 'LÈ W’AP OUVRI APLIKASYON XEROEREUM WALLET LA YON LÒT FWA ANKÒ, KONT OU A AP NAN YON LIS  NAN "ACCOUNTS". ',
...
HELP_13_Desc_1              : 'SA VLE DI KE W’ PA GEN ASE XEROER SOU KONT OUAN POU W’ TA KOUVRI KÒB YO AN GAZ. CHAK TRANSFÈ ( MENM JAN POU TOKENS YO AK KONTRA YO) YO MANDE GAZ, EPI GAZ SA YO PEYE AK XEROER, NIMEWO YO KI PARÈT LA SE KANTITE SA YO MANDE POU W’ KOUVRI KÒB TRANSFÈ A AN WEI. PRAN NIMEWO SA YO DIVIZE YO PA ‘1000000000000000000` EPI SOUSTRÈ KANTITE KÒB LA  AN XEROER KE T’AP ESEYE VOYE A( SI W’ T’AP TANTE VOYE XEROER0). SA PRAL BA W’ KANTITE A AN XEROER KE W’ TE BEZWEN AN POU  KONT LA KA FÈ TRANSFÈ A. ',

HELP_14_Title               : '14) KÈK SIT PA AZA ( KONN REKÒMANSE) KREYASYON KLE SEKRÈ A NAN MOUVMAN ANTRE SÒTI YO. KA SA PA POU MYXEROERWALLET.COM. KANTITE KREYASYON ALE VINI POU MYXEROERWALLET.COM ESKE L’ KONFYAN? ',
HELP_14_Desc_1              : 'MENM KE KANPE MOUVMAN SOURI A ANPIL MOUN JIJE LI GEN ATIRANS , EPI NOU TA KA KONPRANN REZON YO, REYALITE A SE WINDOW.CRYPTO A MEZIRE LIMIT DEZÒD ZIZTÈM PLIS KE MOUVMAN SOURI W’ LA. JAN W’ SÈVI AK MOUVMAN SA YO YO BON MEN NOU(ANSANM AK PLIZYÈ PWOJÈ KRYPTO YO) GEN ANPIL BON REZON POU N’ KWÈ NAN WINDOW.CRYPTO A. ANPLIS, MYXEROERWALLET.COM KAPAB SÈVI SOU EKRAN OU KAPAB TOUCHE YO. MEN YON [KONVÈSASYON KI FÈT AK REDDITOR RAGEUR EPI VITALIK BUTERIN SOU MOUVMAN SOURI YO EPI WINDOW.CRYPTO] (https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) EPI MEN  [SPESYAL W3 YO  WINDOW.CRYPTO AN](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',

HELP_15_Title               : '15) POUKISA KONT SA M’ SOT KREYE A PA PARÈT NAN EKSPLORATÈ BLOCKCHAIN LAN ? (i.e. : etherchain, etherscan) ',
HELP_15_Desc_1              : 'KONT YO PA PARÈT NAN YON EKSPLORATÈ BLOCKCHAIN LÈ YON AKTIVITE FIN FÈT TANKOU, EGZANP, LE N’ TA GEN POU N’ FE YON TRANSFÈ XEROER . ',
...
HELP_21_Desc_2              : 'VÈSYON LONG : XEROEREUM NAN GEN BAZ LI SOU[KRIPTOGRAFI KI GEN KLE PIBLIK ](https://en.wikipedia.org/wiki/Public-key_cryptography), POU PI KLÈ[cryptographie des courbes elliptiques (ECC)](https://eprint.iacr.org/2013/734.pdf) KE YO SOUVAN SÈVI AK LI, PA SÈLMAN NAN XEROEREUM. MAJORITE SÈVÈ YO PWOTEJE AK ECC YO. BITCOIN YO SÈVI AK YO TOU AK SSH, TLS EPI LÒT PWOTOKÒL YO. NAN KA SPESYAL XEROEREUM YO, KLE YO FÈ 256 BITS EPI YO PI FÒ KE SA KI NAN128 YO EPI 192 YO BITS YO, YO TOUJOU SÈVI AK YO EPI YO TOUJOU KONSIDERE YO KONFYAN POU EKSPÈ YO. ',
HELP_21_Desc_3              : 'OU GE YON KLE SEKRÈ EPI YON KLE PIBLIK. KLE SEKRÈ A KAPAB SÈVI POU CHANJE KLE PIBLIK OU A MEN LÒT FASON AN PA POSIB. MENM INTENET EPI TOUT MOND LAN AP SÈVI AK SYSTÈM  KRIPTOGRAFI A SA VLE DI KE, SI TA GEN YON MWAYEN POU CHANJE KLE SEKRÈ A AK KLE PIBLIK LA, RSIK KE XEROER W’ TA KAPAB JWENN NAN SE T’AP YOUN NAN TI KRAS PWOBLÈM YO POU TOUT MOND LAN. ',
HELP_21_Desc_4              : 'SA TA DI, WI : SI YON MOUN GEN KLE SEKRÈ W’ LA , LI KAPAB VOYE XEROER SÒTI NA N KONT OU A, AK ANKÒ SI YON MOUN GEN KÒD SEKRÈ ADRÈS EMAIL OU A, LI KAPAB LI MESSAGE YO OSWA VOYE MESAJ, OSWA SI SE KÒD SEKRÈ KONT BANK OU A, LI KAPAB VOYE NAN KONT PA L’ LA TOU OSWA YON LOT KONT. OU KAPAB PRAN VÈSYON KEYSTORE  KLE SEKRÈ W’ LA KI SE KLE SEKRÈ KI GEN KÒD AK YON KÒD SEKRÈ. SA AP SANBLE AP YON KÒD SEKRÈ KI PWOTEJE AK YON LÒT KÒD SEKRÈ.   ',
...
HELP_21_Desc_8              : 'SA W’ TA SIPOZE BYEN KONPRANN KE KLE YO KREYE YON FASON ALE VINI TOUT ANTYE AVÈK YON SISTÈM KI MEZIRE LIMIT DEZÒD LA. SE KA KLE SA YO KI KREYE LA, MENM JAN AK JAXX EPI MIST/GXERO. BOUS XEROTEREUM YO TOUT BON POU KONSÈY SA. KLE KE SÈVO MOUN YO KREYE YO YO PA KONSA, PASKE KLE SA YO PA KAPAB SÒTI NAN YON BON NIMEWO ALE VINI. TE KONN GEN LÒT PWOBLÈM NAN SISTÈM KI MEZIRE LIMIT DEZÒD LA KI PA SIFI OSWA NAN NIMEWO ALE VINI YO NAN MOND BITCOIN NAN MEN KOUNYE A SE YON LÒT PWOBLÈM LI VIN YE KI KA TANN YON MOMAN. ',

HELP_SecCX_Title            : 'KLE – MYXEROERWALLET CX ',
