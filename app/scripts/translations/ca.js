...
tx_FoundOnChain_3           : '**Si no veus cap error, la teva transacció s\'ha enviat amb èxit.** El teu XERO o Tokens són on els has enviat. Si no pots veure aquest XERO o Tokens a la teva cartera / compte de bescanvi, i han passat més de 24 hores des de l\'enviament, si us plau [contacta amb aquest servei](https://kb.myetherwallet.com/diving-deeper/ethereum-list-of-support-and-communities.html). Envia *l\'enllaç* de la teva transacció si demana amablement que investiguin.',
...
TXFEE_Desc                  : 'La comissió per la TX es paga als miners per incloure la teva TX en un block. És el `límit de gas` * `preu del gas`. [Pots convertir GWEI -> XERO aquí](https://vintage.myetherwallet.com/helpers.html)',
...
/* Footer */
FOOTER_1                    : 'Eina gratuïta, de codi obert que s\'executa en el client per generar carteres d\'Xerom i més. Interactua fàcilment amb la blockchain d\'Xerom de manera fàcil i segura. Comprova l\'URL (.com) abans de desbloquejar la teva cartera.',
FOOTER_1b                   : 'Creat per ',
...
ADD_Ledger_2                : 'Obre l\'aplicació d\'Xerom (o una aplicació de contracte) ',
...
TRANS_sendInfo              : 'Una transacció estàndard utilitzant 21000 gas costarà 0.000441 XERO. Utilitzem un preu una mica per sobre del mínim de 0.000000021 XERO per assegurar que es mina ràpidament. No ens quedem cap comissió per la transacció. ',
...
SWAP_order_CTA              : "Si us plau envia ", // Please send 1 XERO...
...
GXERO_Balance                    :  '(geth-01) Saldo insuficient. Insufficient balance. Your gas limit * gas price + amount to send exceeds your current balance. Send more XERO to your account or use the "Send Entire Balance" button. If you believe this is in error, try pressing generate again. Required (d+) and got: (d+). [Learn More.](https://kb.myetherwallet.com/transactions/transactions-not-showing-or-pending.html)',
GXERO_Cheap                      :  '(geth-02) El preu del gas és massa petit per ser acceptat. Gas price too low for acceptance. Try raising the gas price to 21 GWEI via the dropdown in top-right.',
GXERO_GasLimit                   :  '(geth-03) Excedeix del block gas límit. Exceeds block gas limit. Transaction cost exceeds current gas limit. Limit: (d+), got: (d+). Please lower the gas limit to 21000 (for sending) or 200000 (for sending tokens or contracts) and try again. [Learn More](https://kb.myetherwallet.com/gas/what-is-gas-ethereum.html)',
GXERO_InsufficientFunds          :  '(geth-04) Saldo insuficient per gas * preu + valor. Insufficient balance. Your gas limit * gas price + amount to send exceeds your current balance. Send more XERO to your account or use the "Send Entire Balance" button. If you believe this is in error, try pressing generate again. Required (d+) and got: (d+). [Learn More.](https://kb.myetherwallet.com/transactions/transactions-not-showing-or-pending.html)',
GXERO_IntrinsicGas               :  '(geth-05) Gas intrínsec massa baix. Intrinsic gas too low. Try raising the gas price to 21 GWEI via the dropdown in top-right or the gas limit to 21000 (for sending) or 200000 (for sending tokens or contracts) and try again.',
GXERO_InvalidSender              :  '(geth-06) Emissor no vàlid. Invalid sender.',
GXERO_NegativeValue              :  '(geth-07) Valor negatiu. Negative value.',
GXERO_Nonce                      :  "(geth-08) Nonce massa baix. This TX's [nonce](https://kb.myetherwallet.com/transactions/what-is-nonce.html) is too low. Try incrementing the nonce by pressing the Generate button again, or [replace the pending transaction](https://kb.myetherwallet.com/transactions/check-status-of-ethereum-transaction.html).",
GXERO_NonExistentAccount         :  '(geth-09) El compte no existeix o el saldo és massa baix. Account does not exist or account balance too low',
