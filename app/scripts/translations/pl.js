...
TXFEE_Desc                  : 'The TX Fee is paid to miners for including your TX in a block. Is is the `gas limit` * `gas price`. [You can convert GWEI -> XERO here](https://vintage.myetherwallet.com/helpers.html)',
...
MEW_Tagline                 : 'Portfel Xerom - Open Source, JavaScript, Client-Side ',
CX_Tagline                  : 'Portfel Xerom, Rozszerzenie Chrome - Open Source, JavaScript, Client-Side ',

/* Footer */
FOOTER_1                    : 'Narzędzie do generowania portfeli Xerom i wysyłania transakcji - otwarto-źródłowe, javascrypt\'owe, strony klienta ',
FOOTER_1b                   : 'Twórcy: ',
FOOTER_2                    : 'Darowizny: ',
...
TRANS_warning               : 'Jeśli używasz funkcji "Tylko XERO" lub "Tylko ETC" wysyłasz przez kontrakt. Niektóre serwisy mają problemy z rozpoznawaniem tego typu transakcji. Czytaj dalej. ',
TRANS_advanced              : '+Zaawansowane: Dodaj Dane ',
TRANS_data                  : 'Dane ',
TRANS_sendInfo              : 'Standardowa transakcja, zużywająca 21000 paliwa, będzie kosztować 0.000441 XERO. My używamy ceny paliwa nieco-powyżej-minimum, co odpowiada 0.000000021 XERO aby upewnić się, że zostanie szybko zatwierdzona. Nie pobieramy żadnych dodatkowych opłat. ',
TRANS_gas                   : 'Limit Paliwa ',

/* Send Transaction Modals */
TRANSModal_Title            : 'Transakcje "Tylko XERO" i "Tylko ETC" ',
...
TRANSModal_Content_2        : '**Tylko XERO: ** wysyła przez [Kontrakt zapobiegający powielaniu Timon\'a Rapp\'a (zalecany przez VB)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/), który wysyła środki tylko na łańcuchu **XERO**. ',
...
ADD_Ledger_2                : 'Otwórz aplikację Xerom (lub aplikację kontraktu) ',
...
SWAP_order_CTA              : "Wyślij ", // Please send 1 XERO...
...
ERROR_17                    : 'Niewystarczające środki. Konto, z którego wysyłasz transakcję nie posiada wystarczających funduszy. Musisz mieć **0.01 XERO** na koncie, aby pokryć koszty paliwa. Doładuj konto i spróbuj ponownie. ',
...
/* Geth Error Messages */
GXERO_InvalidSender          : 'Nieprawidłowy nadawca ',
GXERO_Nonce                  : 'Wyróżnik transakcji za niski ',
GXERO_Cheap                  : 'Cena paliwa poniżej akceptacji ',
GXERO_Balance                : 'Niewystarczająca ilość środków na koncie ',
GXERO_NonExistentAccount     : 'Konto nie istnieje lub niewystarczająca ilość środków ',
GXERO_InsufficientFunds      : 'Niewystarczająca ilość środków na paliwo * cena + kwota ',
GXERO_IntrinsicGas           : 'Paliwo poniżej ilości obowiązkowej ',
GXERO_GasLimit               : 'Przekroczono limit paliwa na blok ',
GXERO_NegativeValue          : 'Ujemna wartość ',
...
HELP_8_Desc_1               : 'MyEtherWallet nie jest usługą portfela internetowego. Nie posiadasz loginu i nic nie jest zapisywane na naszych serwerach. To tylko interfejs, który pozwala korzystać z sieci Xerom. ',
HELP_8_Desc_2               : 'Jeżeli MyEtherWallet.com zostanie wyłączona, musiałbyś znaleźć inny sposób (jak Xerom Wallet / Mist) na korzystanie z sieci Xerom. Nie musiałbyś jednak wypłacić swoich środków z MyEtherWallet, ponieważ one nie znajdują się na MyEtherWallet, a na portfelach, które zostały wygenerowane za pomocą naszej strony. ',
HELP_8_Desc_3               : 'Możesz w każdej chwili, w bardzo prosty sposób, zaimportować swoje nieszyfrowane klucze prywatne lub szyfrowane pliki w formacie Geth/Mist wprost do geth / Xerom Wallet / Mist. Zobacz pytanie 12 poniżej. ',
...
HELP_12_Title               : '12) Jak zaimportować portfel utworzony w MyEtherWallet do geth / Xerom Wallet / Mist? ',
...
HELP_12_Desc_7              : 'Uruchom aplikację Xerom Wallet. ',
...
HELP_12_Desc_20             : 'Zostaniesz zapytany o hasło. To będzie hasło portfela w geth / Xerom Wallet / Mist, które należy podać przy każdej transakcji, nie zapomnij tego hasła. ',
HELP_12_Desc_21             : 'Po zaimportowaniu portfela, usuń `nic_specjalnego_usun_mnie.txt` ',
HELP_12_Desc_22             : 'Po ponownym uruchomieniu aplikacji Xerom Wallet Twój portfel pojawi się na zakładce "Accounts". ',
...
HELP_12_Desc_26             : 'Zostaniesz zapytany o hasło. To będzie hasło portfela w geth / Xerom Wallet / Mist, które należy podać przy każdej transakcji, nie zapomnij tego hasła. ',
HELP_12_Desc_27             : 'Po zaimportowaniu portfela, usuń `nic_specjalnego_usun_mnie.txt` ',
HELP_12_Desc_28             : 'Po ponownym uruchomieniu aplikacji Xerom Wallet Twój portfel pojawi się na zakładce "Accounts". ',
...
HELP_21_Desc_2              : 'Długa wersja (dla przedszkolaka): Xerom bazuje na [Kryptografii Klucza Publicznego (ECC)](https://pl.wikipedia.org/wiki/Kryptografia_klucza_publicznego), a dokładnie na [Kryptografii Krzywych Eliptycznych](https://eprint.iacr.org/2013/734.pdf) które są bardzo szeroko stosowane, nie tylko w Xerom. Większość serwerów jest chroniona przez ECC. Kolejne przykłady to Bitcoin, SSH, TLS i wiele innych. Klucze w Xerom to dokładnie odmiana 256-bitowa, która jest silniejsza niż 128-bitowa i 192-bitowa, które również są wciąż szeroko stosowane oraz uznawane przez ekspertów za bezpieczne. ',
HELP_21_Desc_3              : 'W tego typu zabezpieczeniu mamy 2 klucze: klucz prywatny i klucz publiczny. Z klucza prywatnego możemy szybko otrzymać klucz publiczny, ale otrzymanie klucza prywatnego z klucza publicznego jest niemożliwe. Biorąc pod uwagę, że cały internet i wszystkie sekrety świata używają tej metody kryptograficznej oznacza, że gdyby istniał sposób na otrzymanie klucza prywatnego z publicznego, to utrata Twoich środków z konta Xerom byłaby najmniejszym zmartwieniem w świecie. ',
