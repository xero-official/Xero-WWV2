...
ENS_Helper_4                    :  'Tentukan jumlah maksimum XERO yang bersedia Anda bayar untuk nama tersebut (<u>Bid Amount</u> Anda). Pastikan akun memiliki cukup dana untuk membayar tawaran Anda + 0.01 XERO untuk gas.',
...
ENS_Helper_16                   :  'Pemenang akan mendapat pengembalian selisih antara tawaran mereka dan tawaran tertinggi berikutnya. Jika Anda adalah satu-satunya penawar, akan mendapat pengembalian penuh dipotong 0,01 XERO.',
...
ENS_Helper_21                   :  'Mengumumkan Tanggal Peluncuran kembali Xerom Name Service!',
...
ONBOARD_interface_content__6    :  'Jika Anda mengirim *kunci publik (alamat)* kepada seseorang, mereka dapat mengirimkan XERO atau token. 👍',
...
ONBOARD_secure_1_content__4     :  'Pastikan bar URL menunjukkan `MYXEROERWALLET INC` dalam warna hijau.',
...
tx_notFound_4               : 'Gunakan dropdown di kanan atas & pilih node XERO lainnya (e.g. `XERO (Etherscan.io)` atau `XERO (Infura.io)` atau `XERO (MyEtherWallet)`) dan check kembali.',
...
GAS_LIMIT_Desc              : 'Batas Gas (Gas limit) adalah jumlah gas untuk dikirim bersama TX Anda.  `Biaya TX = harga gas * gas limit` & dibayarkan kepada miners untuk memasukkan TX Anda ke dalam block. Menaikkan angka ini tidak mempercepat TX Anda untuk ditambang. Pengiriman XERO = `21000`. Pengiriman Token = ~`200000`.',
...
TXFEE_Desc                  : 'Biaya TX Fee dibayarkan kepada miners untuk memasukkan TX Anda ke dalam block. Jumlahnya =  `gas limit` * `gas price`. [Anda dapat mengkonversi GWEI -> XERO](https://vintage.myetherwallet.com/helpers.html)',
...
/* Footer */
FOOTER_1                    : 'Client-side tool open source berbasis javascript untuk membuat Dompet dan transaksi Xerom. ',
FOOTER_1b                   : 'Oleh ',
...
ADD_Ledger_2                : 'Buka Aplikasi Xerom (atau aplikasi kontrak) ',
...
TRANS_warning               : 'Penggunaan fitur "Hanya XERO" atau "Hanya ETC" memakai pengiriman melalui Kontrak. Beberapa layanan tidak menerima transaksi jenis ini. Baca lebih lanjut. ',
TRANS_advanced              : '+Advanced: Tambah Data ',
TRANS_data                  : 'Data ',
TRANS_gas                   : 'Gas Limit ',
TRANS_sendInfo              : 'Transaksi standar menggunakan 21000 gas membutuhkan 0.000441 XERO. Kami memakai harga gas sedikit-diatas-harga-gas-minimum senilai 0.000000021 XERO untuk mempercepat. Kami tidak mengambil biaya atas transaksi. ',

/* Send Transaction Modals */
TRANSModal_Title            : 'Transaksi "Hanya XERO" dan "Hanya ETC" ',
TRANSModal_Content_0        : 'Catatan terkait jenis transaksi dan layanan: ',
TRANSModal_Content_1        : '**XERO (Transaksi Standar): ** Transaksi default ini melakukan pengiriman langsung dari alamat pengirim ke alamat tujuan. Nilai Gas 21000. Besar kemungkinan XERO yang dikirim dengan metode ini akan di "replay" di rantai ETC. ',
TRANSModal_Content_2        : '**Hanya XERO: ** Pengiriman melalui [kontrak penangkal "replay" oleh Timon Rapp (direkomendasikan oleh VB)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) sehingga hanya dilaksanakan di rantai **XERO** saja. ',
...
TRANSModal_Content_4        : '**Coinbase & ShapeShift: ** Hanya melakukan pengiriman melalui Transaksi Standar saja. Jika Anda mengirim menggunakan "Hanya XERO" atau "Hanya ETC", hubungi layanan konsumen mereka untuk menambahkan saldo Anda secara manual atau membatalkan transaksinya. [Bisa juga dicoba fasilitas "split" dari Shapeshift.](https://split.shapeshift.io/) ',
...
SWAP_init_2                 : " menjadi ", // "I want to swap my X XERO for X BTC"
...
SWAP_progress_3             : "Diterima! ", // XERO Received!
SWAP_progress_4             : "Mengirim {{orderResult.output.currency}} ",
SWAP_progress_5             : "Perintah Selesai ",
SWAP_order_CTA              : "Kirimkan ", // Please send 1 XERO...
SWAP_unlock                 : "Unlock wallet Anda untuk mengirim XERO atau Token langsung dari halaman ini. ",
...
ERROR_17                    : 'Dana tidak mencukupi. Akun yang dipakai untuk mengirim tidak memiliki dana yang cukup. Minimal harus ada **0.01 XERO** di akun untuk menutup biaya gas. Tambahkan ether dan coba lagi. ',
...
/* Geth Error Messages */
GXERO_InvalidSender          : 'Pengirim tidak valid ',
GXERO_Nonce                  : 'Nonce terlalu rendah ',
GXERO_Cheap                  : 'Harga Gas terlalu kecil untuk dapat diterima ',
GXERO_Balance                : 'Saldo tidak mencukupi ',
GXERO_NonExistentAccount     : 'Akun tidak ditemukan atau saldo terlalu rendah ',
GXERO_InsufficientFunds      : 'Tidak cukup saldo untuk gas * harga + nilai ',
GXERO_IntrinsicGas           : 'Gas intrinsik terlalu rendah ',
GXERO_GasLimit               : 'Melebihi limit blok gas ',
GXERO_NegativeValue          : 'Nilai negatif ',
...
HELP_8_Desc_2               : 'Jika situs MyEtherWallet.com tidak berfungsi, Anda harus memakai cara lain (misalnya memakai geth atau Xerom Wallet/Mist) sebagai alternatifnya. Tapi Anda tidak perlu "mengeluarkan" Ether Anda dari MyEtherWallet.com karena Ether Anda tidak disimpan di MyEtherWallet.com. Ether Anda tetap tersimpan dalam dompet yang Anda buat di situs kami. ',
HELP_8_Desc_3               : 'Sekarang Anda dapat mengimpor Kunci Privat yang tidak dienkripsi dan file dalam format Geth/Mist (terenkripsi) langsung ke geth/ Xerom Wallet/Mist dengan sangat mudah. Lihat pertanyaan #12 di bawah ini. ',
...
HELP_12_Title               : '12) Bagaimana cara mengimpor dompet yang dibuat dengan MyEtherWallet ke dalam geth / Xerom Wallet / Mist? ',
...
HELP_12_Desc_7              : 'Buka aplikasi Xerom Wallet. ',
...
HELP_12_Desc_20             : 'Anda akan diminta untuk membuat password baru. Ini adalah password yang akan Anda gunakan di geth/Xerom Wallet/Mist setiap kali Anda akan mengirim transaksi, mohon diingat dan jangan sampai lupa. ',
...
HELP_12_Desc_26             : 'Anda akan diminta untuk membuat password baru. Ini adalah password yang akan Anda gunakan di geth/Xerom Wallet/Mist setiap kali Anda akan mengirim transaksi, mohon diingat dan jangan sampai lupa. ',
...
HELP_21_Desc_2              : 'Jawaban panjang versi ELI5: Xerom dibuat berdasarkan [Public Key Cryptography](https://en.wikipedia.org/wiki/Public-key_cryptography), dan lebih spesifiknya [Elliptic curve cryptography](https://eprint.iacr.org/2013/734.pdf) yang sangat banyak digunakan, tidak hanya di Xerom. Sebagian besar server dilindungi melalui ECC. Bitcoin juga menggunakannya, begitu pula SSH dan TLS dan banyak lagi lainnya. Secara spesifik, Xerom memakai kunci 256-bit, yang lebih kuat dari 128-bit dan 192-bit, yang juga banyak penggunanya dan masih dianggap aman oleh para ahli. ',
