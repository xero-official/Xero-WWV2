...
tx_notFound_4               : 'Utilizza il menu a discesa in alto a destra e scegli un altro nodo XERO (ad esempio `XERO (Etherscan.io)` o `XERO (Infura.io)` o `XERO (MyEtherWallet)`) e ricontrolla.',
...
tx_FoundOnChain_3           : '**Se non vedi errori, la transazione è stata inviata correttamente.** I tuoi XERO o i tuoi token sono dove li hai inviati. Se non vedi questi XERO o token nell\'altro portafoglio / nel conto della piattaforma di scambio, e se sono passate più di 24 ore dall\'invio, [contatta quel servizio esterno](https://kb.myetherwallet.com/diving-deeper/ethereum-list-of-support-and-communities.html). Invia loro il *link* alla transazione e chiedi, cortesemente, di controllare la tua situazione.',
...
TXFEE_Desc                  : 'La commissione transazione si paga ai *miner* perché includano la transazione in un blocco. Si calcola come `limite gas` * `prezzo gas`. [Puoi calcolare la conversione GWEI -> XERO qui](https://vintage.myetherwallet.com/helpers.html)',
...
/* Footer */
FOOTER_1                    : 'Interfaccia gratuita, open source, lato client per generare portafogli Xerom e altro. Interagisci con la *blockchain* Xerom facilmente e in modo sicuro. Controlla bene l\'URL ( myetherwallet.com ) prima di sbloccare un portafoglio.',
FOOTER_1b                   : 'Creato da ',
...
TRANS_sendInfo              : 'Una transazione standard che utilizza 21000 gas costerà 0,000441 XERO. Utilizziamo un prezzo del gas leggermente al di sopra del minimo pari a 0,000000021 XERO per assicurarci che venga elaborata velocemente. Noi non prendiamo commissioni. ',
...
ADD_Ledger_2                : 'Apri l\'applicazione Xerom (o l\'applicazione di un contratto) ',
...
SWAP_progress_3             : "ricevuti! ", // XERO Received!
SWAP_progress_4             : "Invio dei tuoi {{orderResult.output.currency}} ",
SWAP_progress_5             : "Ordine completato ",
SWAP_order_CTA              : "Invia ", // Please send 1 XERO...
SWAP_unlock                 : "Sblocca il tuo portafoglio per inviare XERO o token direttamente da questa pagina. ",
...
ERROR_17                    : 'L\'account dal quale stai provando ad inviare la transazione non ha abbastanza fondi. Se stai inviando token, ti servono 0,01 XERO nel conto per coprire i costi del gas. ',
...
/* Geth Error Messages */
GXERO_InvalidSender          : 'Mittente non valido ',
GXERO_Nonce                  : 'Nonce troppo basso ',
GXERO_Cheap                  : 'Prezzo del gas troppo basso per essere accettato ',
GXERO_Balance                : 'Saldo insufficiente ',
GXERO_NonExistentAccount     : 'Il conto non esiste o il saldo è insufficiente ',
GXERO_InsufficientFunds      : 'Fondi insufficienti per gas * prezzo + valore ',
GXERO_IntrinsicGas           : 'Gas intrinseco troppo basso ',
GXERO_GasLimit               : 'Eccede il limite gas per il blocco ',
GXERO_NegativeValue          : 'Valore negativo ',
...
HELP_Remind_Desc_1          : '**Xerom, MyEtherWallet.com & MyEtherWallet CX, e alcune delle librerie Javascript che utilizziamo sono in continuo sviluppo.** Anche se abbiamo testato approfonditamente e persone di tutto il mondo hanno correttamente creato decine di migliaia di portafogli, c\'è sempre la remota possibilità che accada qualcosa di imprevisto che provochi la perdita dei tuoi XERO. Ti preghiamo di non investire più di quello che sei disposto a perdere, e di fare attenzione. Se dovesse capitare qualcosa, ci dispiace, ma **non siamo responsabili per gli ether perduti**. ',
...
HELP_8_Desc_2               : 'Se MyEtherWallet.com va giù, dovrai trovare un altro modo (come geth o Xerom Wallet / Mist) per fare quello che facciamo noi. Ma non dovrai "tirare fuori" i tuoi ether da MyEtherWallet perché non si trovano in MyEtherWallet. Sono in qualunque portafoglio tu abbia generato tramite il nostro sito. ',
HELP_8_Desc_3               : 'Ora puoi importare direttamente e molto facilmente in geth / Xerom Wallet / Mist la tua chiave privata non crittografata e i tuoi file in formato Geth/Mist (crittografati). Vedi la domanda n. 12 qui sotto. ',
...
HELP_12_Title               : '12) Come faccio a importare un portafoglio creato con MyEtherWallet in geth / Xerom Wallet / Mist? ',
...
HELP_12_Desc_7              : 'Apri l\'applicazione Xerom Wallet. ',
...
HELP_12_Desc_20             : 'Ti verrà chiesto di creare una nuova password. È la password che userai in geth / Xerom Wallet / Mist ogni volta che invierai una transazione, quindi non dimenticarla. ',
HELP_12_Desc_21             : 'A importazione conclusa positivamente, cancella `niente_di_speciale_cancellami.txt` ',
HELP_12_Desc_22             : 'Alla prossima apertura dell\'applicazione Xerom Wallet, il tuo conto sarà mostrato sotto "Accounts". ',
...
HELP_12_Desc_26             : 'Ti verrà chiesto di creare una nuova password. È la password che userai in geth / Xerom Wallet / Mist ogni volta che invierai una transazione, quindi non dimenticarla. ',
HELP_12_Desc_27             : 'A importazione conclusa positivamente, cancella `niente_di_speciale_cancellami.txt` ',
HELP_12_Desc_28             : 'Alla prossima apertura dell\'applicazione Xerom Wallet, il tuo conto sarà mostrato sotto "Accounts". ',
...
HELP_21_Desc_2              : 'Versione lunga in termini semplici: Xerom si basa sulla [Crittografia a chiave pubblica](https://it.wikipedia.org/wiki/Crittografia_a_chiave_pubblica), nello specifico [Crittografia a curva ellittica](https://eprint.iacr.org/2013/734.pdf) (ECC) che è ampiamente utilizzata, non solo in Xerom. La maggior parte dei server sono protetti tramite ECC. Anche Bitcoin la usa, oltre a SSH e TLS e a un sacco di altra roba. Le chiavi di Xerom nello specifico sono di 256 bit, che sono più robuste di 128 bit e 192 bit, che sono anch\'esse ampiamente utilizzate e sono tuttora considerate sicure dagli esperti. ',
...
HELP_21_Desc_8              : 'Certo, tutto ciò assume che le chiavi siano generate in una maniera veramente casuale e con sufficiente entropia. Le chiavi generate qui soddisfano questi criteri, come anche Jaxx e Mist/geth. I portafogli Xerom sono tutti piuttosto buoni. Le chiavi generate dai *brainwallet* non lo sono, dal momento che il cervello di una persona non è capace di creare un seme veramente casuale. Ci sono stati un numero di altri problemi relativi alla mancanza di entropia o a semi non generati in maniera veramente casuale nel mondo di Bitcoin, ma quella è un\'altra questione di cui non parleremo oggi. ',
