...
TXFEE_Desc                  : 'Το τέλος συναλλαγής πληρώνεται στους μεταλλωρύχους για να συμπεριλάβουν τη συναλλαγή σας σε ένα μπλοκ. Είναι το `όριο αερίου` * `τιμή αερίου`. [Μπορείτε να μετατρέψετε GWEI -> XERO εδώ](https://vintage.myetherwallet.com/helpers.html)',
...
/* Footer */
FOOTER_1                    : 'Ένα εργαλείο ανοιχτού κώδικα, javascript, από πλευράς πελάτη για τη δημιουργία πορτοφολιών Xerom & αποστολή συναλλαγών. ',
...
TRANS_warning               : 'Άν χρησιμοποιείτε τις λειτουργίες «Μόνο XERO» ή «Μόνο ETC», η αποστολή γίνεται μέσω συμβολαίων. Ορισμένες υπηρεσίες παρουσιάζουν προβλήματα με την αποδοχή τέτοιων συναλλαγών. Διαβάστε περισσότερα. ',
TRANS_advanced              : '+Για προχωρημένους: Προσθήκη δεδομένων ',
TRANS_data                  : 'Δεδομένα ',
TRANS_gas                   : 'Όριο αερίου ',
TRANS_sendInfo              : 'Μία τυπική συναλλαγή που χρησιμοποιεί 21000 μονάδες αερίου θα κοστίσει 0,000441 XERO. Χρησιμοποιούμε για τιμή αερίου 0.000000021 XERO που είναι λίγο πάνω απο την ελάχιστη ώστε να διασφαλίσουμε ότι θα επικυρωθεί γρήγορα. Δεν παίρνουμε προμήθεια για τη συναλλαγή. ',

/* Send Transaction Modals */
TRANSModal_Title            : 'Συναλλαγές «Μόνο XERO» και «Μόνο ETC» ',
...
TRANSModal_Content_2        : '**Μόνο XERO: ** Αυτό αποστέλλει μέσω του [συμβολαίου προστασίας από επανάληψη του Timon Rapp (όπως συνιστάται από τον Vitalik Buterin)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) ώστε η αποστολή να γίνεται μόνο στην αλυσίδα **XERO**. ',
...
SWAP_order_CTA              : "Παρακαλούμε στείλτε ", // Please send 1 XERO...
...
ADD_Ledger_2                : 'Ανοίξτε την εφαρμογή Xerom (ή μια εφαρμογή συμβολαίου) ',
...
/* Messages */
GXERO_InvalidSender          : 'Μη έγκυρος αποστολέας ',
GXERO_Nonce                  : 'Το nonce είναι πολύ χαμηλό ',
GXERO_Cheap                  : 'Η τιμή αερίου είναι πολύ χαμηλή για να γίνει αποδεκτή ',
GXERO_Balance                : 'Μη επαρκές υπόλοιπο ',
GXERO_NonExistentAccount     : 'Ο λογαριασμός δεν υπάρχει ή το υπόλοιπο του λογαριασμού είναι πολύ χαμηλό ',
GXERO_InsufficientFunds      : 'Μη επαρκή κεφάλαια για αέριο * τιμή + αξία ',
GXERO_IntrinsicGas           : 'Το εγγενές αέριο είναι πολύ χαμηλό ',
GXERO_GasLimit               : 'Υπερβαίνει το όριο αερίου του μπλοκ ',
GXERO_NegativeValue          : 'Αρνητική αξία ',
...
HELP_8_Desc_2               : 'Αν το MyEtherWallet.com πέσει, μπορείτε να χρησιμοποιήσετε κάποιον άλλον τρόπο (όπως το geth ή το Xerom Wallet / Mist) για να κάνετε ό,τι κάνουμε. Αλλά δεν θα χρειαστεί να «βγάλετε» τον Αιθέρα σας από το MyEtherWallet επειδή δεν βρίσκεται μέσα στο MyEtherWallet. Βρίσκεται στο όποιο πορτοφόλι δημιουργήσατε μέσω του ιστοτόπου μας. ',
HELP_8_Desc_3               : 'Μπορείτε να εισαγάγετε πολύ εύκολα το μη κρυπτογραφημένο σας ιδιωτικό κλειδί και τα αρχεία σε φορμά Geth / Mist (κρυπτογραφημένα) απευθείας στο geth / Xerom Wallet / Mist. Δείτε την ερώτηση Νο 12 παρακάτω. ',
