...
tx_notFound_4               : 'Bruk rullegardinmenyen øverst til høyre og velg en annen XERO-node. (f.eks. `XERO (Etherscan.io)` eller `XERO (Infura.io)` eller `XERO (MyEtherWallet)`), og sjekk igjen.',
...
tx_FoundOnChain_3           : '**Hvis du ikke ser noen feil, var transaksjonen vellykket.** Dine XERO eller Tokens er der du sendte dem. Hvis du ikke ser disse XERO eller Tokens der du sendte dem, og det har gått mer enn 24 timer, vennligst [kontakt vedkommende service](https://kb.myetherwallet.com/diving-deeper/ethereum-list-of-support-and-communities.html). Send dem en *lenke* til transaksjonen din og spør dem pent om å se på situasjonen din.',
...
TXFEE_Desc                  : 'Transaksjonsavgiften betales til "utgraverne" for å inkludere transaksjonen din i en blokk. Det er `gas-grense` * `gas-pris`. [Du kan regne om GWEI -> XERO her](https://vintage.myetherwallet.com/helpers.html)',
...
/* Footer */
FOOTER_1                    : 'Et åpen-kildekode-, javascript-, klient-side-verktøy for å opprette Xerom-lommebøker & sende transaksjoner. ',
FOOTER_1b                   : 'Skapt av ',
...
ADD_Ledger_2                : 'Åpne Xerom-applikasjonen (eller kontraktsapplikasjonen) ',
...
TRANS_warning               : 'Hvis du bruker "Kun XERO"- eller "Kun ETC"-funksjonene, sender du via en kontrakt. Noen tjenester har problemer med å akseptere disse transaksjonene. Les mer. ',
TRANS_advanced              : '+Avansert: Legg til data ',
TRANS_data                  : 'Data ',
TRANS_gas                   : 'Gas Limit ',
TRANS_sendInfo              : 'En standard transaksjon som bruker 21000 gas vil koste 0,000441 XERO. Vi bruker en litt-over-minimum gas-pris på 0,000000021 XERO for å sikre at transaksjonen blir raskt behandlet. Vi tar ikke noe transaksjonsgebyr. ',

/* Send Transaction Modals */
TRANSModal_Title            : '"Kun XERO"- og "Kun ETC"-transaksjoner ',
...
TRANSModal_Content_2        : '**Kun XERO: ** Dette sender via [Timon Rapp\'s replay-beskyttelseskontrakt (som anbefalt av VB)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) slik at du kun sender på **XERO**-kjeden. ',
...
SWAP_order_CTA              : "Vennligst send ", // Please send 1 XERO...
...
/* Geth Error Messages */
GXERO_InvalidSender          : 'Feil på avsender ',
GXERO_Nonce                  : 'For liten Nonce ',
GXERO_Cheap                  : 'Gas-pris for lav til å kunne aksepteres ',
GXERO_Balance                : 'Utilstrekkelig saldo ',
GXERO_NonExistentAccount     : 'Kontoen eksisterer ikke eller saldoen er for lav ',
GXERO_InsufficientFunds      : 'Utilstrekkelig med midler for gas * pris + verdi ',
GXERO_IntrinsicGas           : 'Gas-egenverdi for lav ',
GXERO_GasLimit               : 'Overskrider blokkens gas-grense ',
GXERO_NegativeValue          : 'Negativ verdi ',
...
HELP_8_Desc_2               : 'Hvis MyEtherWallet.com går ned, må du finne en annen måte (som f.eks. geth eller Xerom Wallet / Mist) å gjøre det på. Men du vil ikke trenge å "hente" eteren din ut av MyEtherWallet, fordi den ikke befinner seg i MyEtherWallet. Den befinner seg i den lommeboka/kontoen som du opprettet ved hjelp av nettsiden vår. ',
HELP_8_Desc_3               : 'Du kan nå svært enkelt importere din ukrypterte private nøkkel og dine Geth/Mist-format (krypterte) filer direkte inn i geth / Xerom Wallet / Mist. Se spørsmål #12 nedenfor. ',
...
HELP_12_Title               : '12) Hvordan kan jeg importere en lommebok opprettet med MyEtherWallet til geth / Xerom Wallet / Mist? ',
...
HELP_12_Desc_7              : 'Åpne "Xerom Wallet"-programmet. ',
...
HELP_12_Desc_20             : 'Du vil bli bedt om å lage et nytt passord. Dette er passordet du vil bruke i geth / Xerom Wallet / Mist hver gang du skal sende en transaksjon, så ikke glem det. ',
HELP_12_Desc_21             : 'Etter at du har lykkes med å importere kontoen, slett `ikke_noe_spesielt_slett_meg.txt` ',
HELP_12_Desc_22             : 'Neste gangen du åpner "Xerom Wallet"-programmet, vil kontoen din være listet under "Accounts". ',
...
HELP_12_Desc_26             : 'Du vil bli bedt om å lage et nytt passord. Dette er passordet du vil bruke i geth / Xerom Wallet / Mist hver gang du skal sende en transaksjon, så ikke glem det. ',
HELP_12_Desc_27             : 'Etter at du har lykkes med å importere kontoen, slett `ikke_noe_spesielt_slett_meg.txt` ',
HELP_12_Desc_28             : 'Neste gangen du åpner "Xerom Wallet"-programmet, vil kontoen din være listet under "Accounts". ',
...
HELP_21_Desc_2              : 'Lang ELI5-versjon: Xerom er basert på [Offentlig nøkkel-kryptografi](https://en.wikipedia.org/wiki/Public-key_cryptography), og mer spesifikt [Elliptic curve cryptography](https://eprint.iacr.org/2013/734.pdf), som er svært utbredt, ikke bare i Xerom. De fleste servere er beskyttet via ECC. Bitcoin bruker den samme, likeså SSH og TLS og mange flere. Xerom-nøklene er 256-bit nøkler, som er sterkere enn 128-bit og 192-bit, som også er mye brukt og fortsatt betraktes som sikre av ekspertene. ',
