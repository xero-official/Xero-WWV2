...
/* Footer */
FOOTER_1                    : 'Free, open-source, client-side interface for generating Xerom wallets &amp; more. Interact with the Xerom blockchain easily &amp; securely. Double-check the URL ( myetherwallet.com ) before unlocking your wallet.',
...
TRANS_warning               : 'Nếu bạn sử dụng chức năng "Chỉ XERO" hoặc "Chỉ ETC" trong việc gửi đi thông qua một hợp đồng thông minh. Những dịch vụ có chức năng chấp nhận các giao dịch. Đọc Thêm. ',
TRANS_advanced              : 'Nâng Cao: Thêm Dữ Liệu ',
TRANS_data                  : 'Dữ Liệu: ',
TRANS_gas                   : 'Gas Limit: ',
TRANS_sendInfo              : 'Mỗi Giao dịch Phổ Thông sử dụng hết 21000 gas có giá tương đương 0.000441 XERO. Chúng tôi áp dụng giá Gas dành cho một giao dịch cao hơn so với mức tối thiểu là 0.000000021 XERO nhằm đảm bảo một giao dịch được diễn ra nhanh. Chúng tôi hoàn toàn không nhận được khoản tiền phát sinh nào từ phí giao dịch. ',

/* Send Transaction Modals */
TRANSModal_Title            : 'Giao Dịch "Chỉ XERO" Và "Chỉ ETC" ',
...
TRANSModal_Content_2        : '**Chỉ XERO: ** Phương pháp này sẽ thực hiện giao dịch thông qua [Hợp đồng thông minh nhằm "tránh việc phát lại" được phát triển bởi Timon Rapp (theo lời cảnh báo của VB)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) vì vậy giao dịch này chỉ được thực hiện trên chuổi **XERO**. ',
...
ADD_Ledger_2                : 'Mở Lên Ứng Dụng Của Xerom (Hoặc một ứng dụng của Hợp Đồng) ',
...
ERROR_17                    : 'Bạn cần có ít nhất **0.01 XERO** trong tài khoản để thanh toán chi phí gas. Hãy thêm một số ether và thực hiện lại. ',
...
/* Geth Error Messages */
GXERO_InvalidSender          : 'Sai người nhận ',
GXERO_Nonce                  : 'Nonce quá thấp ',
GXERO_Cheap                  : 'Gas quá thấp ',
GXERO_Balance                : 'Số dư tài khoản không đủ ',
GXERO_NonExistentAccount     : 'Tài khoản không tồn tại hoặc số dư không đủ ',
GXERO_InsufficientFunds      : 'Số dư không đủ thanh toán cho gas * Giá + Giá trị ',
GXERO_IntrinsicGas           : 'Số gas quá thấp ',
GXERO_GasLimit               : 'Số gas vượt mức giới hạn đối với một Block ',
GXERO_NegativeValue          : 'Cảnh báo xấu về lượng gas ',
...
TranslatorName_2            : '[và Xerom Vietnam](https://www.ethereumvn.com) ',
...
HELP_8_Desc_2               : 'Nếu MyEtherWallet.com bị sập, bạn sẽ phải tìm một giải pháp khác (như là geth hoặc Ví Xerom / Mist) dễ tiếp tục thực hiện giao dịch. Nhưng bạn không cần thiết phải "Mang" Ether của bạn ra khỏi MyEtherWallet bởi vì số Ether đó không nằm trong MyEtherWallet. Bởi vì số Ether đó đang nằm trong Ví Xerom được khởi tạo thông qua trang của chúng tôi. ',
HELP_8_Desc_3               : 'Bạn chỉ cần bỏ tập tin chứa định dạng mã hoá Private key của bạn vào và Geth/Mist sẽ tự động giải mã tập tin (mã hoá) trực tiếp bên trong  geth / Ví Xerom / Mist một cách dễ dàng. Xem câu hỏi #12. ',
...
HELP_12_Title               : '12) Làm thế nào dễ tôi sử dụng Ví được khởi tạo từ MyEtherWallet trên geth / Ví Xerom / Mist? ',
...
HELP_12_Desc_7              : 'Truy cập Ví trên ứng dụng Ví Xerom. ',
...
HELP_12_Desc_20             : 'Việc này sẽ yêu cầu bạn thực hiện một mật khẩu mới. Và nó sẽ là mật khẩu mà bạn sử dụng tại geth / Ví Xerom / Mist . Lưu ý, Bạn phải ghi nhớ mật khẩu này. ',
HELP_12_Desc_21             : 'Sau khi hoàn thành việc nhập Ví trên ứng dụng, bạn nên xoá tập tin `nothing_special_delete_me.txt` ',
HELP_12_Desc_22             : 'Trong lần sử dụng ứng dụng Ví Xerom sau này, Tài khoản của bạn sẽ tự đọng liên kết và hiển thị dưới phần "Accounts". ',
...
HELP_12_Desc_26             : 'Việc này sẽ yêu cầu bạn thực hiện một mật khẩu mới. Và nó sẽ là mật khẩu mà bạn sử dụng tại geth / Ví Xerom / Mist . Lưu ý, Bạn phải ghi nhớ mật khẩu này. ',
HELP_12_Desc_27             : 'Sau khi hoàn thành việc nhập Ví trên ứng dụng, bạn nên xoá tập tin `nothing_special_delete_me.txt` ',
HELP_12_Desc_28             : 'Trong lần sử dụng ứng dụng Ví Xerom sau này, Tài khoản của bạn sẽ tự đọng liên kết và hiển thị dưới phần "Accounts". ',
...
HELP_21_Desc_2              : 'Phiên bản dài ELI5: Bởi vậy Xerom được dựa trên [Public Key Cryptography](https://en.wikipedia.org/wiki/Public-key_cryptography), Đặc biệt là [Mật mã đường cong Elliptic](https://eprint.iacr.org/2013/734.pdf) Được sử dụng rất rộng rãi, không chỉ duy nhất ở Xerom. Hầu hết các Server được bảo vệ thông qua ECC. Bitcoin cũng tương tự, cũng giống như SSH và TLS và rất nhiều thứ khác. Mã khoá của Xerom cụ thể bao gồm 256-bit ký tự, Đoạn mã đó dài và khó đoán hơn đoạn mã 128-bit và 192-bit, mặc dù 128-bit và 192-bit hiện cũng được dùng khá rộng rãi và vẫn được nhận định là rất bảo mật từ các chuyên gia. ',
...
HELP_21_Desc_8              : 'Tất cả những giả đinh trên nhằm xác định rõ đoạn mã được tạo ra một cách hoàn toàn ngẫu nhiên. các mã khoá được tạo ra ở đây đáp ứng các tiêu chí, mà có thể tương tích đc với Jaxx và Mist/Geth. Ví Xerom là tất cả những gì tuyệt vời nhất. Keys generated by brainwallets do not, as a person\'s brain is not capable of creating a truly random seed. There have been a number of other issues regarding lack of entropy or seeds not being generated in a truly random way in Bitcoin-land, but that\'s a separate issue that can wait for another day. ',
