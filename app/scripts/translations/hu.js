...
/* General */
x_AddessDesc                : 'Your Address can also be known as you `Account #` or your `Public Key`. It is what you share with people so they can send you Ether or Tokens. Find the colorful address icon. Make sure it matches your paper wallet & whenever you enter your address somewhere. Úgy is ismerheted ezt, mint "Számlaszám" vagy "Publikus Kulcs". Ez az amit a partnereidnek küldesz, hogy tudjanak XERO-et küldeni neked. Az oldalsó ikon egyszerű módja a saját címed felismerésének. ',
...
/* Footer */
FOOTER_1                    : 'Egy nyílt forrású, javascript-alapú, kliens-oldali eszköz Xerom Tárcák létrehozására és tranzakicók végrehajtására. ',
...
TRANS_warning               : 'Ha a "Csak XERO" vagy a "Csak ETC" Funkciókat használod a küldés kontraktuson keresztül megy végbe. Néhány szolgáltatásnak problémái lehetnek az ilyen tranzakciók elfogadásával. Kattints és tudj meg többet. ',
TRANS_advanced              : '+Haladó: Több Adat ',
TRANS_data                  : 'Adat ',
TRANS_gas                   : 'Gas Limit ',
TRANS_sendInfo              : 'Egy standard tranzakció 21000 gas-t használ, ami 0.000441 XERO-be fog kerülni. Mi 0.000000021 XERO-nél (a minimálisnál) enyhén magasabb gas árat használunk, annak biztosítása érdekében, hogy gyorsan ki legyen bányászva. Tranazkciós költséget nem számolunk fel. ',

/* Send Transaction Modals */
TRANSModal_Title            : '"Csak XERO" és "Csak ETC" Tranzakciók ',
TRANSModal_Content_0        : 'Egy jegyzet a különféle tranzakciókról és szolgáltatásokról ',
TRANSModal_Content_1        : '**XERO (Standard Tranzakció): ** Egy alapértelmezett tranzakciót generál közvetlenül az egyik címről a másikra. A gas alapértéke 21000. Valószínűsíthető, hogy minden XERO, ami ezzel a módszerrel lesz elküldve, végbemegy az ETC láncon is. ',
TRANSModal_Content_2        : '**Csak XERO: **  Ez a tranzakciótípus [Timon Rapp replay protection/visszajátszás elleni védelem kontraktusán keresztül küld (ahogy azt Vitalik Buterin adjánlotta)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) tehát a küldés csak az **XERO** láncon megy végbe. ',
...
ADD_Ledger_2                : 'Nyisd meg az Xerom applikációt (vagy egy kontraktus applikációt) ',
...
/* Geth Error Messages */
GXERO_InvalidSender          : 'Érvénytelen küldő ',
GXERO_Nonce                  : 'a Nonce túl alacsony ',
GXERO_Cheap                  : 'A Gas ára túl alacsony az elfogadáshoz ',
GXERO_Balance                : 'Hiányos egyenleg ',
GXERO_NonExistentAccount     : 'A Számla nem létezik vagy az egyenleg túl alacsony ',
GXERO_InsufficientFunds      : 'Hiányos alap a gas-hoz * ár + érték ',
GXERO_IntrinsicGas           : 'Intrinsic gas túl alacsony ',
GXERO_GasLimit               : 'Meghaladja a blokk gas limitjét ',
GXERO_NegativeValue          : 'Negatív érték ',
...
HELP_Remind_Desc_1          : 'Az **Xerom, MyEtherWallet.com és MyEtherWallet CX, továbbá néhány, az oldal által használt JavaScript könyvtár aktív fejlesztés alatt állnak.** Az alapos tesztelés és a világszerte több tízezer sikeresen létrehozott tárca ellenére mindig fennáll az apró lehetőség arra, hogy valami váratlan esemény miatt elveszted az XERO-id. Ne fektess be annál többet, mint amit hajlandó lennél elveszítnei. Ha esetleg bármi ilyen történne, nagyon sajnáljuk, de **nem vagyunk a felősek az elvesztett Etherekért**. ',
