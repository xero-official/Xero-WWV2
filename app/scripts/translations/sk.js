...
TRANS_warning               : 'If you are using the "Only XERO" or "Only ETC" Functions you are sending via a contract. Some services have issues accepting these transactions. Read more. ',
...
TRANSModal_Title            : '"Only XERO" and "Only ETC" Transactions ',
...
TRANSModal_Content_2        : '**Only XERO: ** This sends via [Timon Rapp\'s replay protection contract (as recommended by VB)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) so that you only send on the **XERO** chain. ',
...
/* Geth Error Messages */
GXERO_InvalidSender          : 'Invalid sender ',
GXERO_Nonce                  : 'Nonce too low ',
GXERO_Cheap                  : 'Gas price too low for acceptance ',
GXERO_Balance                : 'Insufficient balance ',
GXERO_NonExistentAccount     : 'Account does not exist or account balance too low ',
GXERO_InsufficientFunds      : 'Insufficient funds for gas * price + value ',
GXERO_IntrinsicGas           : 'Intrinsic gas too low ',
GXERO_GasLimit               : 'Exceeds block gas limit ',
GXERO_NegativeValue          : 'Negative value ',
