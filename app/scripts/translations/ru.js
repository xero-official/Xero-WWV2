...
MEW_Tagline                 : 'Xerom кошелёк на javascript с открытым исходным кодом ',
CX_Tagline                  : 'Xerom кошелёк на javascript с открытым исходным кодом в виде расширения для браузера Chrome ',

/* Footer */
FOOTER_1                    : 'Написанный на javascript инструмент с открытым исходным кодом для создания Xerom кошельков и выполнения транзакций. ',
FOOTER_1b                   : 'Авторы: ',
...
TRANS_warning               : 'Если Вы используете функции "только XERO" или "только ETC", перевод будет выполнен с помощью контракта. У некоторых сервисов могут возникнуть проблемы с приёмом таких переводов. Уточните этот вопрос. ',
...
TRANSModal_Title            : 'Транзакции вида "только XERO" и "только ETC" ',
TRANSModal_Content_0        : 'О видах транзакций и сервисах: ',
TRANSModal_Content_1        : '**Эфир (ether, обычная транзакция): ** Выполняет обычный перевод напрямую с одного адреса на другой. Используется стандартное количесвто газа: 21000. В большинстве случаев, перевод XERO, выполненный этим способом, можно будет продублировать для ETC. ',
TRANSModal_Content_2        : '**Только XERO: ** Выполняет перевод через [контракт Тимона Раппа, защищающий от дублирования переводов (рекомендован ВБ)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/), поэтому перевод будет выполнен только в **XERO**. ',
...
SWAP_order_CTA              : "Пожалуйста, отправьте ", // Please send 1 XERO...
...
ADD_Ledger_2                : 'Запустите приложение Xerom (или приложение контракта) ',
...
/* Geth Error Messages */
GXERO_InvalidSender          : 'Неверный адрес отправителя ',
GXERO_Nonce                  : 'Номер перевода (nonce) слишком мал ',
GXERO_Cheap                  : 'Цена газа слишком низкая ',
GXERO_Balance                : 'Баланс недостаточен ',
GXERO_NonExistentAccount     : 'Счёт не существует или баланс счёта слишком мал ',
GXERO_InsufficientFunds      : 'Недостаточно средств для ГАЗ * ЦЕНА + СУММА ',
GXERO_IntrinsicGas           : 'Недостаточно газа для выполнения транзакции ',
GXERO_GasLimit               : 'Превышен лимит газа на блок ',
GXERO_NegativeValue          : 'Отрицательная сумма ',
